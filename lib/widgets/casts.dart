...
import 'package:moviehome/bloc/get_casts_bloc.dart';
        ...
        StreamBuilder<CastResponse>(
          ...
          builder: (context, AsyncSnapshot<CastResponse> snapshot) {
            if (snapshot.hasData) {
              ...
              return _buildCastsWidget(context, snapshot.data);
...
Widget _buildCastsWidget(BuildContext context, CastResponse data) {
